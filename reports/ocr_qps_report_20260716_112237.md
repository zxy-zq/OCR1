...
- 预热请求：1 次
- 机器可见逻辑核心数：8
- 明细数据：`ocr_qps_results_20260716_112237.csv`
...
- 本轮最高 QPS：0.479，出现在 8 核、1 worker、ORT线程 2、并发 1。
- 单核峰值：0.000 QPS。
...
|---:|---:|---:|---:|---:|---:|---:|
| 8 | 1 | 2 | 1 | 0.479 | 0.00x | 2086.4 |

## 全量结果

| CPU核心数 | Worker数 | ORT线程 | 并发数 | QPS | 成功率 | 平均延迟(ms) | P95(ms) | P99(ms) | 成功/总请求 |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 8 | 1 | 2 | 1 | 0.479 | 100.00% | 2086.4 | 2086.4 | 2086.4 | 1/1 |
